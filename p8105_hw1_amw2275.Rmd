...
The Penguins data set describes different species of penguins and their attributes, including different species such as  `r unique(pull(penguins, species))`, and their island in Antarctica such as `r unique(pull(penguins, island))`. The set contains `r nrow(penguins)` observations and `r ncol(penguins)` variables. 
